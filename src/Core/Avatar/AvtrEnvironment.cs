...
namespace Outpost31.Core.Avatar
{
    ...
    /// <remarks>
    ///   An Avatar environment consists of two components: the <see cref="AvtrSys">Avatar System</see> and <see cref="AvtrSysCode">Avatar System Code</see>.<br/>
    ///   <br/>
    ...
    internal class AvtrEnvironment
    {
        ...
        /// <remarks>
        ///   It is <b><i>very important</i></b> that <c>AvtrSys</c> is set correctly, otherwise lots of bad things can <i>and will</i> happen!<br/>
        ///   <br/>
        ...
        ///     <br/>
        ///     Organizations may have many different Avatar <i>System Codes</i>, but only a few Avatar <see cref="AvtrSys"/>.<br/>
        ///     <br/>
